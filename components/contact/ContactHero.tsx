...
export default function ContactHero() {
  ...
  const getBlobPath = () => {
    ...
    if (isRTL) {
      return 'M0,900 L0,800 C100,620 300,880 500,710 C700,540 750,830 950,660 C1150,490 1280,720 1440,500 L1440,900 Z';
    }
    return 'M1440,900 L1440,800 C1340,620 1140,880 940,710 C740,540 690,830 490,660 C290,490 160,720 0,500 L0,900 Z';
  };
