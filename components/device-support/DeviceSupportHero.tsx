        ...
        <div className="grid gap-6 md:grid-cols-2 lg:gap-8 items-stretch">
          ...
          <div className="relative min-h-[440px] md:min-h-full overflow-hidden rounded-[40px] text-white flex items-center justify-center">
            ...
            <div className="w-[92%] h-auto aspect-square relative drop-shadow-[0_20px_40px_rgba(0,0,0,0.3)] select-none pointer-events-none z-10">
              ...
              >
                <p className="text-[13px] font-medium leading-snug">
                  {t('hero.floatingPrefix')} <span className="text-primary font-bold">{t('hero.floatingHighlight')}</span>
                </p>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className={`absolute top-24 md:top-4 -right-2 md:right-4 z-20 p-3 rounded-2xl`}
            >
            ...
            <motion.div
              className={`absolute bottom-24 md:bottom-8 left-0 md:left-2 z-20 flex flex-col gap-3`}
              initial="hidden"
              animate="visible"
              variants={{
                hidden: { opacity: 0 },
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="relative flex items-center justify-center w-6 h-6 md:w-11 md:h-11 rounded-full bg-primary-heading/90 backdrop-blur-sm border border-white/10 text-white shadow-lg group transition-colors duration-200"
                >
                  <motion.div
